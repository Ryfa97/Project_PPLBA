...
<body>
        ...
        <table class="table1"width="100%">
            <tr>
                <td class="tengah" >
                    ...
                    <h1 style="margin-left:100px; font-size:30px">SMK Negeri 1 Pacitan</h1>
                    <h3 style="margin-left:100px; font-size:16px">(Terakreditasi "A")</h3>
                    <h2 style="margin-left:100px; font-size:16px">JL. LETJEND SOEPRAPTO NO. 53, BAREAN, PLOSO, PACITAN</h2>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: center; background-color:rgb(28, 151, 23); margin-top:0">
                    <h7 style="color: white; font-size:12px">Sekretariat : Jl. Letjend Soeprapto No. 53, Pacitan Telp. (0357) 881309 Email : info.smkn1pacitan@gmail.com</h7>
                </td>
            </tr>
        </table>
    </div>
    <div >
        ...
        <h2 class="isi" style="font-size:16px">TAHUN PELAJARAN 2024/2025</h2>
